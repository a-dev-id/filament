                        ...
                        <div class="col-12 col-md-6 d-flex flex-column justify-content-between order-1">
                            ...
                            <div class="col-12 col-md-6 d-flex flex-column justify-content-between order-2">
                                ...
                                <div class="pe-3">
                                    ...
                                    <a href="https://book-directonline.com/properties/nandinibalidirect?locale=en&promocode={{$data->promo_code}}&checkInDate={{date('Y-m-d')}}&checkOutDate={{date('Y-m-d',strtotime('+'.$data->min_night.' days'))}}&currency=USD&trackPage=yes" class="btn btn-sm btn-primary text-uppercase py-2 px-3 rounded-0" target="_blank">{{$data->button_text}}</a>
