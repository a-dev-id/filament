                        ...
                        <div class="col-12 col-md-5 d-flex flex-column justify-content-between order-1">
                            ...
                            <div class="col-12 col-md-1 order-2 d-flex justify-content-center align-items-center">
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <a onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=700');return false;" href="//twitter.com/intent/tweet?text={{$data->title}} - Wedding at Nandini Jungle by Hanging gardens ({{ Str::limit($data->excerpt,50) }}...Read more on our website!): {{route('weddings.index')}}" target="_blank" class="rounded-circle border-secondary text-secondary link-share link-share-twitter m-1"><i class="fa fa-twitter"></i></a>
                                </div>
                            </div>
