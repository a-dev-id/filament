...
<x-desktop>
    ...
    <section>
        ...
        @if ($key % 2 == 0) <div class="py-5 bg-light-gray"> @else <div class="py-5"> @endif
                <div class="container">
                    <div class="row">
                        @if ($key % 2 == 0) <div class="col-12 col-md-5 d-flex flex-column justify-content-between order-1"> @else <div class="col-12 col-md-5 d-flex flex-column justify-content-between order-3"> @endif
                            ...
                            @if ($key % 2 == 0) <div class="col-12 col-md-6 order-3"> @else <div class="col-12 col-md-6 order-1"> @endif
