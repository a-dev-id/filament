...
<head>
    ...
    <title>Nandini Bali | Dining</title>
    <meta name=”description” content="">
    <meta property="og:title" content="" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://nandinibali.com/m/dining" />
    <meta property="og:image" content="" />
    <meta name="facebook-domain-verification" content="7gux91mjnq02ohqrs58juc6ow82uhe" />
    <script type="text/javascript">
        <!--
        if (screen.width > 768) {
            window.location = "https://nandinibali.com/";
          }
          //
        -->
    </script>
    ...
    <link href="https://nandinibali.com/combine/c64ac969fd80c8f0ebd4392e84cda8e5-1664419839" rel="stylesheet">
...
s.parentNode.insertBefore(t,s)}(window, document,'script',
'https://connect.facebook.net/en_US/fbevents.js');
fbq('init', '3024301144536343');
fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=3024301144536343&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->

    <!-- Event snippet for Nandini Contact Page conversion page
In your html page, add the snippet and call gtag_report_conversion when someone clicks on the chosen link or button. -->
  ...
  gtag('event', 'conversion', {
      'send_to': 'AW-11066683333/uvTECKrtp4kYEMXfgJ0p',
  ...
  return false;
    ...
    <!-- Event snippet for Nandini Homepage Outbond Click conversion page
In your html page, add the snippet and call gtag_report_conversion when someone clicks on the chosen link or button. -->
    <script>
        function gtag_report_conversion(url) {
  var callback = function () {
  ...
  gtag('event', 'conversion', {
      'send_to': 'AW-11066683333/5kCwCK3tp4kYEMXfgJ0p',
      'event_callback': callback
  });
  return false;
}
...
<body id="home" style="margin-bottom: 165px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="facebook-container social-container">
                        ...
                        <a href="javascript:void(0)" data-sharer="facebook" data-url="https://nandinibali.com/m/dining"> Share on Facebook</a>
                    </div>
                    <div class="twitter-container social-container">
                        <div class="icon-container">
                            <i class="fa fa-twitter" aria-hidden="true"></i>
                        </div>
                        <a href="javascript:void(0)" data-sharer="twitter" data-url="https://nandinibali.com/m/dining"> Share on Twitter</a>
                    </div>
                    <div class="whatsapp-container social-container">
                        <div class="icon-container">
                            <i class="fa fa-whatsapp" aria-hidden="true"></i>
                        </div>
                        <a href="javascript:void(0)" data-sharer="whatsapp" data-title="" data-url="https://nandinibali.com/m/dining"> Share on Whatsapp</a>
                    </div>
                    <div class="mail-container social-container">
                        <div class="icon-container">
                            <i class="fa fa-envelope-o" aria-hidden="true"></i>
                        </div>
                        <a href="mailto:?subject=&body=https://nandinibali.com/m/dining"> Share on Email</a>
                    </div>
                    <div class="phone-container social-container">
                        <div class="icon-container">
                            <i class="fa fa-copy" aria-hidden="true"></i>
                        </div>
                        <a onclick="copyToClipboard('#myText')" id="copyUrl" value="https://nandinibali.com/m/dining" href="javascript:void(0)"> Copy URL to clipboard</a>
                        <span id="myText" class="hide">https://nandinibali.com/m/dining</span>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row dining-row-item">
            <div class="col-xs-12">
                <a class="d-block" href="javascript:void(0)">
                    <div style="background: url(https://nandinibali.com/storage/app/uploads/public/613/e02/2dc/613e022dcf76d688777942.png) no-repeat center; height: 230px; background-size: cover;"></div>
                </a>
            </div>
            <div class="col-xs-12 dining-item-description">
                <div class="block-content">
                    <a href="javascript:void(0)">
                        <h1>Romantic Dining By The River</h1>
                    </a>
                    <div class="text-justify">
                        <p>Imagine having a romantic dinner under the twinkling stars in the heart of ubud jungle, right by the Ayung river and the sounds of the jungle. Best of all there’s only the two of you, surrounded by no one else except nature. Nandini’s special chef and our staff will serve you an amazing set menu of exquisite dishes while you enjoy the scenery. At the edge of the river bank, you will get a private table where you can enjoy the magnificent natural atmosphere and the music of the rushing water.</p>
                    </div>

                    <div class="padding-top-30">
                        <div class="col-xs-6">
                            <form id="enquiryForm-5" method="post" action="https://nandinibali.com/m/enquiry">
                                <input type="hidden" name="package_name" value="">
                                <input type="hidden" name="package_excerpt" value="">
                                <input type="hidden" name="package_image" value="https://nandinibali.com/storage/app/uploads/public/613/e00/ec4/613e00ec4ecc4735986800.jpg">
                                <button type="submit" style="width:100%!important" class="btn-enquire">INQUIRE NOW</button>
                            </form>
                        </div>
                        <div class="col-xs-6">
        ...
        <div class="row dining-row-item">
            <div class="col-xs-12">
                <a class="d-block" href="javascript:void(0)">
                    <div style="background: url(https://nandinibali.com/storage/app/uploads/public/637/9ea/3ce/6379ea3ce550f872062736.jpg) no-repeat center; height: 230px; background-size: cover;"></div>
                </a>
            </div>
            <div class="col-xs-12 dining-item-description">
                <div class="block-content">
                    <a href="javascript:void(0)">
                        <h1>Romantic Dining By The Chapel</h1>
                    </a>
                    <div class="text-justify">
                        <p>Surprise the love of your life with an ultimate romantic dinner hidden from the world, under the moonlight and surreal ambience, treated like royalty during your stay at Nandini Bali. Simply looking for a magical night out together, take a unique and unforgettable romantic evening you will never forget underneath our iconic chapel overlooking mystical jungle pool.</p>
                    </div>
        ...
        <div class="row dining-row-item">
            <div class="col-xs-12">
                <a class="d-block" href="javascript:void(0)">
                    <div style="background: url(https://nandinibali.com/storage/app/uploads/public/613/e02/90e/613e0290e48ba842758067.jpeg) no-repeat center; height: 230px; background-size: cover;"></div>
                </a>
            </div>
            <div class="col-xs-12 dining-item-description">
                <div class="block-content">
                    <a href="javascript:void(0)">
                        <h1>Feast of the Senses</h1>
                    </a>
                    <div class="text-justify">
                        <p>"Food is not like anything else, it is something precious!", said our Executive Chef Gustu. Bringing the precious out of food requires the best of ingredients and best of cooking methods.</p>
                    </div>
    ...
    <div class="container-fluid container-fixed-menu">
        ...
        <a href="https://nandinibali.com/m" class="menu-box">
            <div class="menu-box-item ">
                <i class="fa fa-home"></i>
                <p>Home</p>
            </div>
        </a>
        <a href="https://nandinibali.com/m/accommodation" class="menu-box">
            <div class="menu-box-item ">
                <i class="fa fa-bed"></i>
                <p>Accommodation</p>
            </div>
        </a>
        <a href="https://nandinibali.com/m/offer" class="menu-box">
            <div class="menu-box-item ">
        ...
        <div class="contact-us-box">
            <ul>
                ...
                <li>
                    <div class="items">
                        <a href="https://api.whatsapp.com/send/?phone=6281236871170&text" class="items-contact-us"><i class="fab fa-whatsapp" aria-hidden="true"></i></a>
                    </div>
                </li>
            </ul>
        </div>
        <div class="media-box">
            <ul>
                <li>
                    <div class="items">
                        <a href="https://nandinibali.com/m/gallery" class="items-menu" style="color: #fff; font-size: 10px">Gallery</a>
                    </div>
                </li>
                <li>
                    <div class="items">
                        <a href="https://nandinibali.com/m/blog" class="items-menu" style="color: #fff; font-size: 10px">Blog</a>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <!-- <script src="https://nandinibali.com/themes/mindimedia/assets/mobile/js/bootstrap.min.js"></script> -->
    <!-- <script src="https://nandinibali.com/themes/mindimedia/assets/js/folding-content.js"></script>  -->
    <script src="https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.js" defer></script>
    <!-- <script src="https://nandinibali.com/themes/mindimedia/assets/javascript/sharer.js"></script> -->
    <script type="text/javascript">
